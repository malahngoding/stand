            ...
            <x-jet-form-section submit="addTeamMember">
                ...
                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-black-700">
                                    ...
                                    <button type="button"
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center">
                                                <div
                                                    class="text-sm text-black-700 {{ $addTeamMemberForm['role'] == $role->key ? 'font-semibold' : '' }}">
                                                    {{ $role->name }}
                                                </div>
                                            ...
                                            <!-- Role Description -->
                                            <div class="mt-2 text-xs text-black-700">
                                                {{ $role->description }}
                                            </div>
                                        </div>
                                    </button>
                    ...
                    <div class="space-y-6">
                        @foreach ($team->teamInvitations as $invitation)
                            <div class="flex items-center justify-between">
                                <div class="text-black-700">{{ $invitation->email }}</div>
                ...
                @foreach ($this->roles as $index => $role)
                    <button type="button"
                        ...
                        <div class="{{ $currentRole !== $role->key ? 'opacity-50' : '' }}">
                            ...
                            <div class="flex items-center">
                                <div
                                    class="text-sm text-black-700 {{ $currentRole == $role->key ? 'font-semibold' : '' }}">
                                    {{ $role->name }}
                                </div>
