<div x-data>
    <div class="flex flex-col items-start justify-between pb-6 space-y-4 lg:space-y-0 lg:flex-row">
        <ul>
            <li>
                <h1 class="text-2xl font-semibold whitespace-nowrap">Questions</h1>
            </li>
        </ul>
        <ul>
            <li>
                ...
                <table class="min-w-max table-auto w-full whitespace-no-wrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3">Quiz Group Name</th>
                            <th class="px-4 py-3">Question Count</th>
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800 border-b-2 border-gray-200">
                        <tr class="text-black dark:text-gray-400 ">
                            <td wire:click="getTaxon('{{$taxon->id}}')" class="px-4 py-3">
                                <div>
                                    <p class="px-4 py-3 text-xm"> {{$taxon->groupname }}</p>
                                </div>
                            </td>
