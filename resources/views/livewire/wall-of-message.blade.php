<div x-data>
    ...
    <div class="flex flex-col items-start justify-between pb-6 space-y-4  lg:items-center lg:space-y-0 lg:flex-row">
        <ul>
            <li>
                <h1 class="text-2xl font-semibold whitespace-nowrap">Wall of message</h1>
            </li>
        </ul>
        <ul>
            <li>
                <div class="my-2 flex sm:flex-row flex-col">
                    ...
                    <div class="block relative ">
                        ...
                        <input type="text" placeholder="Search" wire:model="search_query"
                        ...
                        {{-- @if ($sugesstion) --}}
                        {{-- <select class="h-full absolute w-full border bg-white rounded px-3 py-2 outline-none text-gray-700" multiple>
                                @foreach ($searchs as $search)
                                <option class="py-1">{{$search->improperMessage }}</option>
                        @endforeach
                        </select> --}}
                        {{-- @endif --}}
                    </div>
    ...
    <div>
        ...
        <div class="w-auto overflow-hidden rounded-lg shadow-xs mr-6">
                ...
                <table class="min-w-max table-auto w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800 border-b-2 border-gray-200">
                        <tr class="text-black dark:text-gray-400 ">
                            <td class="px-4 py-3">
                                <div>
                                    <p class="px-4 py-3 text-xm">{{$search->name }}</p>
                                </div>
                            </td>
                            ...
                            <td class="px-4 py-3 text-sm">
                                <div class="flex item-center justify-center">
                                    ...
                                    <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                        <svg wire:click="delete_wall('{{$search->id}}')"
            ...
            {{ $searchs->links('custom-pagination-links-view') }}
        </div>
    </div>
