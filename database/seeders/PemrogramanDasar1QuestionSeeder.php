...
class PemrogramanDasar1QuestionSeeder extends Seeder
{
    ...
    public function run()
    {
        $array_answer1 = array('Analisis masalah', 'Dokumentasi', 'Mencari bug', 'Estimasi program');
        $answer1 = implode("|", $array_answer1);
        $array_answer2 = array('Analytic phase', 'Correct phase', 'Implementation phase', 'Delegation Phase');
        $answer2 = implode("|", $array_answer2);
        $array_answer3 = array('Java', 'Python', 'C#', 'Notepad');
        $answer3 = implode("|", $array_answer3);
        $array_answer4 = array('Menguji algoritma', 'Menemukan ide membuat program', 'Menentukan ide solusi', 'Menganalisis algoritma');
        $answer4 = implode("|", $array_answer4);
        $array_answer5 = array('Proses', 'Rangka', 'Algoritma', 'Diagram');
        $answer5 = implode("|", $array_answer5);
        $array_answer6 = array('Bahasa inggris', 'Bahasa mesin', 'Bahasa pemrograman', 'Bahasa struktur');
        $answer6 = implode("|", $array_answer6);
        $array_answer7 = array('Tujuan visi algoritma', 'Tujuan algoritma', 'Logika algoritma', 'Susunan dalam membuat program');
        $answer7 = implode("|", $array_answer7);
        $array_answer8 = array('Judul (berisi judul algoritma) - Deskripsi (berisi deklarasi variabel dan konstanta) - Implementasi (berisi inti algoritma)', 'Judul - Algoritma - Implementasi', 'Judul - Html - Implementasi', 'Semua benar');
        $answer8 = implode("|", $array_answer8);
        $array_answer9 = array('Html', 'Java', 'Fortran', 'Pseudocode');
        $answer9 = implode("|", $array_answer9);
        $array_answer10 = array('Sebelum pembuatan program', 'Sesudah pembuatan program', 'Pada saat verifikasi program', 'Pada saat program selesai dibuat, dan percobaan dijalankan');
        $answer10 = implode("|", $array_answer10);
        $array_answer11 = array('Struktur', 'Flowchart', 'Design', 'Matriks');
        $answer11 = implode("|", $array_answer11);
        $array_answer12 = array('Masalah-Model-Algoritma-Program-Eksekusi-Hasil', 'Algoritma-Program-Model-Hasil', 'Masalah-Algoritma-Program-Hasil', 'Masalah-Algoritma-Flowchart-Program-Eksekusi-Hasil');
        $answer12 = implode("|", $array_answer12);
        $array_answer13 = array('1111', '1011', '1001', '0101');
