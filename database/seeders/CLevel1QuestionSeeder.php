...
class CLevel1QuestionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $array_answer1 = array('print<<“Hello World”;', 'echo “Hello World”;', 'System.out.print(“Hello World”);');
        $answer1 = implode("|", $array_answer1);
        $array_answer2 = array('/* Ini komentar', '# Ini komentar',  '< Ini komentar >');
        $answer2 = implode("|", $array_answer2);
        $array_answer3 = array(':',  ']', '}');
        $answer3 = implode("|", $array_answer3);
        $array_answer4 = array('cout',  'getch', 'input');
        $answer4 = implode("|", $array_answer4);
        $array_answer5 = array('konstanta',  'define', 'function');
        $answer5 = implode("|", $array_answer5);
        $array_answer6 = array('String', 'txt', 'TXT');
        $answer6 = implode("|", $array_answer6);
        $array_answer7 = array('bilangan int;', 'var bilangan;',  '$bilangan;');
        $answer7 = implode("|", $array_answer7);
        $array_answer8 = array('Char', 'String', 'Integer');
        $answer8 = implode("|", $array_answer8);
        $array_answer9 = array('Char', 'String',  'Double');
        $answer9 = implode("|", $array_answer9);
        $array_answer10 = array('integer', 'float', 'double');
        ...
        DB::table('quiz_question')->insert(
            [
                ...
                'correct_answer' => 'char / Tergantung angka didalam tanda[]',
                'picture' => "2yW9qASopdHq00DOUtE7CkgkTsRlmOvHUjaR3ksm.jpg",
                'created_at' => now(),
                'updated_at' => now(),
            ]
