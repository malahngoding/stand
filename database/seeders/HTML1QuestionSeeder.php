...
class HTML1QuestionSeeder extends Seeder
{
    ...
    public function run()
    {
        $array_answer1 = array('Hyperlink Markup Language', 'Hypertext Markup Language', 'Hypertext May Language', 'Hypertext Markup Laceration');
        $answer1 = implode("|", $array_answer1);
        $array_answer2 = array('Karna punya variable', 'Karna punya pengkondisian', 'Karna tidak punya keduanya', 'Jawaban A dan B benar');
        $answer2 = implode("|", $array_answer2);
        $array_answer3 = array('Nikola Tesla', 'Thomas Alfa Edison', 'Beners', 'Tim Beners-Lee');
        $answer3 = implode("|", $array_answer3);
        $array_answer4 = array('1997', '1998', '1995', '2009');
        $answer4 = implode("|", $array_answer4);
        $array_answer5 = array('.DOC', '.JS', '.HTML', '.CSS');
        $answer5 = implode("|", $array_answer5);
        $array_answer6 = array('<HTML>', 'HTML', '(HTML)', '[HTML]');
        $answer6 = implode("|", $array_answer6);
        $array_answer7 = array('Komponen penting dari tag pembuka hingga tag penutup', 'Gabungan dari atribut tag HTML', 'Gabungan dari tag pembuka hingga tag penutup', 'Gabungan dari tag-tag pada HTML');
        $answer7 = implode("|", $array_answer7);
        $array_answer8 = array('title', 'src', 'href', 'disable');
        $answer8 = implode("|", $array_answer8);
        $array_answer9 = array('title', 'src', 'href', 'disable');
        $answer9 = implode("|", $array_answer9);
        $array_answer10 = array('Judul pada sebuah kalimat', 'Judul pada sebuah Web Browser', 'Judul pada sebuah konten/artikel', 'Judul pada sebuah HTML');
