...
class HTML2QuestionSeeder extends Seeder
{
    ...
    public function run()
    {
        $array_answer1 = array('<h4>', '<h5>', '<h6>', '<h7>');
        $answer1 = implode("|", $array_answer1);
        $array_answer2 = array('<body =’background:green’>', '<body style=’background-color:green’>', '<body color=’green’>', '<background>green</background>');
        $answer2 = implode("|", $array_answer2);
        $array_answer3 = array('<bold>', '<b>', '<i>', '<important>');
        $answer3 = implode("|", $array_answer3);
        $array_answer4 = array('<table>', '<tables>', '<tb>', '<tab>');
        $answer4 = implode("|", $array_answer4);
        $array_answer5 = array('Membuat baris', 'Membuat kolom', 'Membuat header tabel', 'Membuat body tabel');
        $answer5 = implode("|", $array_answer5);
        $array_answer6 = array('List terurut', 'List Tidak terurut', 'List Tunggal', 'List Jamak');
        $answer6 = implode("|", $array_answer6);
        $array_answer7 = array('Benar', 'Salah', 'Jawaban a dan b benar', 'Semua jawaban salah');
        $answer7 = implode("|", $array_answer7);
        $array_answer8 = array('<textarea>', ' <input type=’textarea’>', '<text>', 'Semua jawaban salah');
        $answer8 = implode("|", $array_answer8);
        $array_answer9 = array('<img href=’https://kelasprogrammer.com’ alt=’Kelas Programmer’>', '<img src=’kelasprogrammer.png’ alt=’Kelas Programmer’>', '<image src=’kelasprogrammer.jpg’ alt=’Kelas Programmer’>', '<img type=’kelasprogrammer.gif’>');
        $answer9 = implode("|", $array_answer9);
        $array_answer10 = array('dimulai dengan <!– diakhiri dengan –>', 'dimulai dengan <? diakhiri dengan ?>', 'dimulai dengan // diakhiri dengan *//', 'dimulai dengan # diakhiri dengan #');
